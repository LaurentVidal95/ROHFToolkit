...
struct ChemicalSystem{T <: Real}
    ...
    four_index_tensor ::AbstractArray{T}
...
function ChemicalSystem(mol::PyObject)
    ...
    A = mol.intor("int2e", aosym=4) # TODO Arriver a calculer E depuis A sym
...
Base.collect(Σ::ChemicalSystem) = (Σ.four_index_tensor, Σ.core_hamiltonian,
